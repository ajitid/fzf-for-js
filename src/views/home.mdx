...
and you query for 'pi' you will get Pikachu, Vulpix and Typholsion but if you query for 'Pi' you will get only Pikachu back. This can be customized in options.
