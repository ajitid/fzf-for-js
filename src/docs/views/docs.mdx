...
<span className="docs-hidden">
  <i>
    If you are reading this file on GitHub, we'll suggest to read it on{" "}
    <a href="https://fzf.netlify.app">documentation website</a> instead.
  </i>
</span>

<div className="flex justify-between flex-wrap">
  <div>
    <Link to="basic">Demo</Link> · [GitHub](https://github.com/ajitid/fzf-for-js) ·
    [NPM](https://www.npmjs.com/package/fzf)
  </div>
  <div>
    Docs for v{pkg.version} (<Link to="/docs">Change</Link>) ·{" "}
    <Link to="/migrate">Migration Guide</Link>
  </div>
</div>
