...
Find a <Link to="basic">working example</Link> for this and its [sourcecode](https://github.com/ajitid/fzf-for-js/blob/bc2efca25e96b60b95ca56c5a84d423d9b2bee77/src/docs/views/basic.tsx#L98).
