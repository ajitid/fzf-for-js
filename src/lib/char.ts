...
export const isWhitespace = (rune: Int32Array[0]) => whitespaceRunes.has(rune);

export const whitespacesAtStart = (runes: Int32Array) => {
  let whitespaces = 0;
...
export const whitespacesAtEnd = (runes: Int32Array) => {
  let whitespaces = 0;
